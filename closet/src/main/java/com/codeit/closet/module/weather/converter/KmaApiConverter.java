...
public class KmaApiConverter {
  ...
  /**
   * 단기예보 응답을 WeatherData 리스트로 변환 - 3일간 3시간 간격 예보
   */
  ...
  /**
   * PTY 코드 → PrecipitationType 변환 0: 없음, 1: 비, 2: 비/눈, 3: 눈, 4: 소나기
   */
  ...
  /**
   * SKY 코드 → SkyStatus 변환 (단기예보) 1: 맑음, 3: 구름많음, 4: 흐림
   */
  ...
  /**
   * PCP (1시간 강수량) 문자열 → Double 변환 "강수없음", "1mm 미만" 등 처리
   */
  ...
  /**
   * WSD (풍속) → WindStrength 변환 4m/s 미만: WEAK, 4~9m/s: MODERATE, 9m/s 이상: STRONG
   */
